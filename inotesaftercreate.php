...
$sql="CREATE TABLE `notes`.`$datatable` ( `sno` INT NOT NULL AUTO_INCREMENT , `tittle` TEXT NOT NULL , `description` TEXT NOT NULL , `date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,PRIMARY KEY (`sno`))";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `$datatable` ( `tittle`, `description`) VALUES ( '$tittle', '$description')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $insert = true;
    } else {
...
<form action="inotesaftercreate.php" method="post">
